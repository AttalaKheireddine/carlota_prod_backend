...
def predict(data):
    ...
    for renting_price in range(50,1001,50):
    ...
    return {"Price": best_price, "Delay":round(float(best_delay[0]),2)}
...
test_dico = {
 'host_neighbourhood': 'Hammersmith',
 ...
 'shared_bath': 0.0,
 'half_bath': 0.0,
 'price_estimate': 574978.0782608696,
 'amenity_count': 48,}
